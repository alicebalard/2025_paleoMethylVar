...
DIR="/SAN/ghlab/epigen/Alice/paleo_project/data/02samplesBams/Marchi2022"
...
## --> keep only UDR/USER treated files 
...
METADATA="/SAN/ghlab/epigen/Alice/paleo_project/data/00samplesList/metadata_Marchi2022_15samples.tsv"
DAM="$DIR/damage/ct_damage_profile.csv"

## Subset METADATA for all the run_accession for which the second column of DAM < 0.1 (after seeing the damage plot)
OUTPUT="$DIR/damage/filtered_metadata.tsv"
