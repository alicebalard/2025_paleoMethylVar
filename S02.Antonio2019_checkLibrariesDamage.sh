...
INDIR="/SAN/ghlab/epigen/Alice/paleo_project/data/01rawfastq/Antonio2019/TEMP/01Trimmed_data"
OUTDIR="/SAN/ghlab/epigen/Alice/paleo_project/data/02samplesBams/Antonio2019"
...
for bam in "$INDIR"/*.filtered.sorted.dedup.bam; do
